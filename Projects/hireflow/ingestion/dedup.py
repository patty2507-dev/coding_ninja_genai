...
def candidate_exists(candidate_id: str) -> bool:
    ...
    try:
        ...
        result = index.list(prefix=candidate_id, limit=1) # this is like sql query --> select * from table where candidate_id = '9hD4o@example.com'
        ids = list(result)
        return len(ids) > 0
    except Exception:
        return False
...
if __name__ == "__main__":
    print(candidate_exists("9hD4o@example.com"))